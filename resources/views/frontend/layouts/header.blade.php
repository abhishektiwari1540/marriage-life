...
<body>
    ...
    <div id="preloader">
        <div class="plod">
            <span class="lod1"><img src="{{ asset('frontend/images/loder/1.png')}}" alt="" loading="lazy"></span>
            <span class="lod2"><img src="{{ asset('frontend/images/loder/2.png')}}" alt="" loading="lazy"></span>
            <span class="lod3"><img src="{{ asset('frontend/images/loder/3.png')}}" alt="" loading="lazy"></span>
        </div>
    </div>
    ...
    <div class="menu-pop menu-pop1">
        ...
        <div class="inn">
            <img src="{{ asset('frontend/images/logo-b.png')}}" alt="" loading="lazy" class="logo-brand-only">
            ...
            <div class="row">
                <div class="hom-nav">
                    ...
                    <div class="logo">
                        ...
                        <a href="{{  route('frontend.index') }}" class="logo-brand"><img src="{{ asset('frontend/images/logo-b.png')}}" alt="" loading="lazy"
                                class="ic-logo"></a>
                    </div>
                    ...
                    <div class="bl">
                        <ul>
                                ...
                                <div class="smenu-open smenu-multi">
                                    <div class="container">
                                            ...
                                            <div class="multi-col">
                                                <div class="inn">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="{{  route('frontend.sign_up') }}">Sign-up</a></li>
                                                        @endif
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('frontend.user_profile')}}">My profile</a></li>
                            ...
                            @if(!Auth::check())
                            <li><a href="{{  route('frontend.sign_up') }}">Register</a></li>
                            @endif
                            <li class="smenu-pare">
