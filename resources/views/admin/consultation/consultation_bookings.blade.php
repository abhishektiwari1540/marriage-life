					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								<a href="{{route('consultation.bookingsExport')}}" class="btn btn-primary mr-2">
									Export
								</a>
									...
									<div>
										<div class="row mb-6">
											<div class="col-lg-3 mb-lg-5 mb-6">
												...
												<input type="text" class="form-control" name="consultation_name" placeholder="Consultation Name" value="{{$searchVariable['consultation_name'] ?? '' }}">
											</div>
											<div class="col-lg-3 mb-lg-5 mb-6">
										...
										<thead>
											<tr class="text-uppercase">
												<th class="{{(($sortBy == 'title' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'title' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													<a href="javascript:void(0)">Consultation Name</a>
												</th>
																	...
																	<tr>
																		<td>
																			<div class="text-dark-75 mb-1 font-size-lg">
																				{{$result?->consultationDetails->name ?? '' }}
																			</div>
																		</td>
																		<td>
																			<div class="text-dark-75 mb-1 font-size-lg">
