                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            ...
                            {{Config('constants.TESTIMONIAL.TESTIMONIAL_TITLE')}}
                         </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="col-xl-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <option value="{{ $list->id }}"
                                                {{ old('consultation_category_id') ?? $modelDetails->consultation_category_id  == $list->id ? 'selected' : '' }}>
                                                {{ $list->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                  ...
                                  <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control form-control-solid form-control-lg  @error('short_description') is-invalid @enderror" cols="30" rows="5" id="shortDescription">{{old('short_description')??$modelDetails?->short_description}}</textarea>
                                ...
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control form-control-solid form-control-lg   @error('description') is-invalid @enderror" cols="30" rows="5" id="description">{{old('description')??$modelDetails?->description}}</textarea>
