        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    Edit  {{Config('constants.REIKIHEALING.REIKIHEALING_TITLE')}}</h5>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xl-10">
                                ...
                                @if(!empty($modelDetails->ReikiHealingSpecification) && count($modelDetails->ReikiHealingSpecification)>0)
                                @foreach($modelDetails->ReikiHealingSpecification as $data)
                                <div class="form-group appended_name_div">
                                    <label for="name">Name</label><span class="text-danger"> * </span>
