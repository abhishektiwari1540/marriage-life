			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						{{Config('constants.SPELL_BOOKING.SPELL_BOOKING_TITLES')}}
					</h5>
									...
									<div>
										<div class="row mb-6">
											<div class="col-lg-3 mb-lg-5 mb-6">
												...
												<input type="text" class="form-control" name="reiki_title" placeholder="Pooja Title" value="{{$searchVariable['pooja_title'] ?? '' }}">
											</div>
											<div class="col-lg-3 mb-lg-5 mb-6">
