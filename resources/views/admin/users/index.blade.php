            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                       {{Config('constants.CUSTOMER.CUSTOMERS_TITLES')}}
                   </h5>
                ...
                <div class="card card-custom card-stretch card-shadowless">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <a href='{{route("$model.Exports")}}' class="btn btn-primary mr-3"> {{ trans("Export ") }}</a>
                            <a href="javascript:void(0);" class="btn btn-primary dropdown-toggle mr-2" data-toggle="collapse" data-target="#collapseOne6">
                                Search
                            </a>
                            <a href='{{route("$model.create")}}' class="btn btn-primary"> {{ trans("Add New ") }}{{Config('constants.CUSTOMER.CUSTOMERS_TITLE')}}</a>
                        </div>
                    </div>
                    <div class="card-body">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right pr-2">
                                            ...
                                            <a href="{{route($model.'.changedPassword',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Change Password" data-original-title="Change Password">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                            ...
                                            <a href='{{URL::to("adminpnlx/customers/send-credentials","$result->id")}}' class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Send Credentials" data-original-title="Send Credentials">
