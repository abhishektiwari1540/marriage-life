...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{Config('constants.SPELLS.SPELLS_TITLE')}}
                    </h5>
    ...
    <?php
    $createPermission   = functionCheckPermission("SpellsController@create");
    $viewPermission     = functionCheckPermission("SpellsController@view");
    $deletePermission   = functionCheckPermission("SpellsController@delete");
    $statusPermission   = functionCheckPermission("SpellsController@changeStatus");
    ?>
                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("$model.create")}}' class="btn btn-primary"> {{ trans("Add New ") }} {{Config('constants.SPELLS.SPELLS_TITLE')}}</a>
                            </div>
                        </div>
                        <div class="card-body">
