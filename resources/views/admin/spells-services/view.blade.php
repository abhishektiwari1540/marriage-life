         ...
         <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline flex-wrap mr-5">
               <h5 class="text-dark font-weight-bold my-1 mr-5">
                  View {{Config('constants.SPELLS.SPELLS_TITLE')}}
               </h5>
            ...
            <div class="card-header card-header-tabs-line">
                  ...
                  <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x" role="tablist">
                     <li class="nav-item">
                        <a class="nav-link active hide_me" data-toggle="tab" href="#kt_apps_contacts_view_tab_1">
                           <span class="nav-text">
                              {{Config('constants.SPELLS.SPELLS_TITLE')}} Information
                           </span>
                        </a>
                     </li>
                     <li class="nav-item">
               ...
               <div class="card-body px-0">
                  ...
                  <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                   ...
                   <tbody>
                     @if($modelDetails->spellSpecification)
                     @foreach($modelDetails->spellSpecification as $k=> $val)
                     <tr>
                      <td>
