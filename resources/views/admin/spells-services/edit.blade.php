        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    Edit  {{Config('constants.SPELLS.SPELLS_TITLE')}}</h5>
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route($model.'.index')}}" class="text-muted"> 
                                {{Config('constants.SPELLS.SPELLS_TITLES')}}
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="col-xl-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="short_title" class="form-control form-control-solid form-control-lg  @error('short_title') is-invalid @enderror" value="{{old('short_title')??$modelDetails->short_title}}">
                                ...
                                @if(!empty($modelDetails->spellSpecification) && count($modelDetails->spellSpecification)>0)
                                @foreach($modelDetails->spellSpecification as $data)
                                <div class="form-group appended_name_div">
                                    <label for="name">Name</label><span class="text-danger"> * </span>
                                    <input type="text" name="name[]" class="form-control form-control-solid form-control-lg  @error('name') is-invalid @enderror" value="{{old('name')??$data->title}}">
                                    @if ($errors->has('name'))
                                    <div class=" invalid-feedback">
                                        {{ $errors->first('name') }}
                                    </div>
