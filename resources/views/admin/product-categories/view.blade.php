                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            View {{Config('constants.PRODUCT_CATEGORY.PRODUCT_CATEGORY_TITLE')}}
                        </h5>
                            ...
                            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-bold nav-tabs-line-3x"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active hide_me" data-toggle="tab"
                                        ...
                                        <span class="nav-text">
                                            {{Config('constants.PRODUCT_CATEGORY.PRODUCT_CATEGORY_TITLE')}}
                                            Information
                                        </span>
                                    </a>
                                </li>
                                ...
                                <div class="dataTables_wrapper ">
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody>
                                                @if ($modelDetails->coursesSpecification)
                                                    @foreach ($modelDetails->coursesSpecification as $k => $val)
                                                        <tr>
                                                            <td>
