...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        Edit  {{Config('constants.FAQ.FAQ_TITLE')}} </h5>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <form action="{{route($model.'.update',base64_encode($modelDetails->id))}}" method="post" class="mws-form" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="faq_order" class="form-control form-control-solid form-control-lg  @error('faq_order') is-invalid @enderror" value="{{$modelDetails->faq_order ?? old('faq_order')}}">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="question" class="form-control form-control-solid form-control-lg @error('question') is-invalid @enderror" value="{{$modelDetails->question ?? old('question')}}">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="body_{{$language->id}}" name="answer" class="form-control form-control-solid form-control-lg  @error('answer') is-invalid @enderror">
                                                    {{ $modelDetails->answer ?? old('answer')}}</textarea>
