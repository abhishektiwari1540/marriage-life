...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        {{Config('constants.POOJA_SERVICE.POOJA_SERVICE_TITLE')}}
                    </h5>
    ...
    <?php
    $createPermission   = functionCheckPermission("PoojaServicesController@create");
    $viewPermission     = functionCheckPermission("PoojaServicesController@view");
    $deletePermission   = functionCheckPermission("PoojaServicesController@delete");
    $statusPermission   = functionCheckPermission("PoojaServicesController@changeStatus");
    ?>
                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("$model.create")}}' class="btn btn-primary"> {{ trans("Add New ") }} {{Config('constants.POOJA_SERVICE.POOJA_SERVICE_TITLE')}}</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="row mb-6">
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                ...
                                                <select name="status" class="form-control select2init" value="{{$searchVariable['status'] ?? ''}}">
                                                    ...
                                                    <option value="1" {{ isset($searchVariable['status']) && $searchVariable['status'] == 1 ? 'selected': '' }}>Activate</option>
                                                    <option value="0" {{ isset($searchVariable['status']) && $searchVariable['status'] == 0 ? 'selected': '' }}>Deactivate</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                                <label>Title</label>
                                             ...
                                             <div class="col-lg-3 mb-lg-5 mb-6">
                                                <label>Price</label>
                                                <input type="text" class="form-control" name="price" placeholder="Price" value="{{$searchVariable['price'] ?? '' }}">
                                            </div>
                                            <div class="col-lg-3 mb-lg-5 mb-6">
                                        ...
                                        <thead>
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="{{(($sortBy == 'title' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'title' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
                                                    <a href="{{route($model.'.index',array(	'sortBy' => 'title',
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="text-dark-75 mb-1 font-size-lg">
                                                        <a class="fancybox-buttons" data-fancybox-group="button" href="{{ $result->image }}">
                                                            <img height="50" width="50" src="{{ $result->image }}" />
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-right pr-2">
                                                    ...
                                                    @if($result->status == 1)
                                                    <a title="Click To Deactivate" href='{{route("$model.changeStatus",array($result->id,0))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Deactivate">
                                                    ...
                                                    @else
                                                    <a title="Click To Activate" href='{{route("$model.changeStatus",array($result->id,1))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Activate">
                                                    ...
                                                    <a href="{{route($model.'.edit',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Edit" data-original-title="Edit">
                                                    ...
                                                    <a href="{{route($model.'.show',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-primary btn-sm" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="View" data-original-title="View">
                                                        <span class="svg-icon svg-icon-md svg-icon-primary">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24" />
                                                    ...
                                                    <a href="{{route($model.'.delete',array(base64_encode($result->id)))}}" class="btn btn-icon btn-light btn-hover-danger btn-sm confirmDelete" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" title="Delete" data-original-title="Delete">
                                                        <span class="svg-icon svg-icon-md svg-icon-danger">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                    <rect x="0" y="0" width="24" height="24" />
