			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						{{Config('constants.POOJA_TRANSACTION.POOJA_TRANSACTION_TITLES')}}
					</h5>
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								<a href="{{route('poojaTransactionsExport')}}" class="btn btn-primary mr-2">
									Export
								</a>
																...
																<tr>
																	{{-- <td>
																		...
																		<div class="text-dark-75 mb-1 font-size-lg">
																			<a href="{{ url('adminpnlx/pooja-services/' . base64_encode($result->pooja_id)) }}" target="_blank" rel="noopener noreferrer">
																				{{ $result?->title ?? '' }}
																			</a>                                                                    
																		</div>
																	</td> --}}
