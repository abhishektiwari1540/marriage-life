					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								<a href="{{route('poojaBookingsExport')}}" class="btn btn-primary mr-2">
									Export
								</a>
									...
									<div>
										<div class="row mb-6">
											<div class="col-lg-3 mb-lg-5 mb-6">
												<label>Pooja Title</label>
												<input type="text" class="form-control" name="pooja_title" placeholder="Pooja Title" value="{{$searchVariable['pooja_title'] ?? '' }}">
											</div>
											<div class="col-lg-3 mb-lg-5 mb-6">
										...
										<thead>
											<tr class="text-uppercase">
												<th class="{{(($sortBy == 'title' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'title' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													<a href="javascript:void(0)">Pooja Title</a>
												</th>
