                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        <h5 class="text-dark font-weight-bold my-1 mr-5">
                            {{ Config('constants.COURSE_TRANSACTION.COURSE_TRANSACTION_TITLES') }}
                        </h5>
                        ...
                        <div class="card card-custom card-stretch card-shadowless">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                    <a href="{{ route('courseTransactionsExport') }}" class="btn btn-primary mr-2">
                                        Export
                                    </a>
                                        ...
                                        <div>
                                            <div class="row mb-6">
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <select name="payment_status" class="form-control select2init"
                                                        value="{{ $searchVariable['payment_status'] ?? '' }}">
                                                ...
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    ...
                                                    <input type="text" class="form-control" name="transaction_id"
                                                        ...
                                                        value="{{ $searchVariable['transaction_id'] ?? '' }}">
                                                </div>
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label>User Name</label>
                                                    <input type="text" class="form-control" name="user_name"
                                                        placeholder="User Name"
                                                        value="{{ $searchVariable['user_name'] ?? '' }}">
                                                </div>

                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                                    <label>Amount</label>
                                                    <input type="text" class="form-control" name="amount"
                                                        placeholder="Amount" value="{{ $searchVariable['amount'] ?? '' }}">
                                                </div>
                                                <div class="col-lg-3 mb-lg-5 mb-6">
                                            ...
                                            <div class="row mt-8">
                                                <div class="col-lg-12">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href='{{ route("$model.bookingsTransactions") }}'
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                {{-- <tr class="text-uppercase">
                                                    <th
                                                    class="{{ $sortBy == 'transaction_id' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'transaction_id' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                    <a
                                                        href="#">Course Name</a>
                                                </th> --}}
                                                    <th
                                                        class="{{ $sortBy == 'transaction_id' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'transaction_id' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                        <a
                                                            href="{{ route($model . '.bookingsTransactions', [
                                                    ...
                                                    <th
                                                        class="{{ $sortBy == 'booking_amount' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'booking_amount' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                    ...
                                                    <th
                                                        class="{{ $sortBy == 'amount' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'amount' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                        <a
                                                            href="{{ route($model . '.bookingsTransactions', [
                                                                'sortBy' => 'amount',
                                                    ...
                                                    <th
                                                        class="{{ $sortBy == 'payment_status' && $order == 'desc' ? 'sorting_desc' : ($sortBy == 'payment_status' && $order == 'asc' ? 'sorting_asc' : 'sorting') }}">
                                                        <a
                                                            href="{{ route($model . '.bookingsTransactions', [
                                                        ...
                                                        <tr>
                                                            {{-- <td>
                                                                <div class="text-dark-75 mb-1 font-size-lg">
                                                                    <a href="{{ url('adminpnlx/courses/' . base64_encode($result->course_id)) }}" target="_blank" rel="noopener noreferrer">
                                                                        {{ $result?->name ?? '' }}
                                                                    </a>                                                                    
                                                                </div>
                                                            </td> --}}
