                    ...
                    <div class="card card-custom card-stretch card-shadowless">
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href='{{route("$model.create")}}' class="btn btn-primary"> {{ trans("Add New ") }} {{Config('constants.PRODUCT_TITLE.PRODUCT_TITLE')}} </a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right pr-2">
                                                    ...
                                                    @if($result->is_active == 1)
                                                    <a title="Click To Deactivate" href='{{route("$model.changeStatus",array($result->id,1))}}' class="btn btn-icon btn-light btn-hover-danger btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Deactivate">
                                                    ...
                                                    @else
                                                    <a title="Click To Activate" href='{{route("$model.changeStatus",array($result->id,0))}}' class="btn btn-icon btn-light btn-hover-success btn-sm status_any_item" data-toggle="tooltip" data-placement="top" data-container="body" data-boundary="window" data-original-title="Activate">
