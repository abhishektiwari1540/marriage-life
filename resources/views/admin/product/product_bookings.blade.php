			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						{{Config('constants.PRODUCT_BOOKING.PRODUCT_BOOKING_TITLE')}}
					</h5>
					...
					<div class="card card-custom card-stretch card-shadowless">
						<div class="card-header">
							...
							<div class="card-toolbar">
								<a href="{{route('productBookingsExport')}}" class="btn btn-primary mr-2">
									Export
								</a>
									...
									<div>
										<div class="row mb-6">
											<div class="col-lg-3 mb-lg-5 mb-6">
												...
												<input type="text" class="form-control" name="booking_number" placeholder="Booking Number" value="{{$searchVariable['booking_number'] ?? '' }}">
											</div>
											<div class="col-lg-3 mb-lg-5 mb-6">
									...
									<table class="table dataTable table-head-custom table-head-bg table-borderless table-vertical-center" id="taskTable">
										<thead>
											<tr class="text-uppercase">
												<th class="{{(($sortBy == 'booking_number' && $order == 'desc') ? 'sorting_desc' : (($sortBy == 'booking_number' && $order == 'asc') ? 'sorting_asc' : 'sorting'))}}">
													<a href="{{route($model.'.bookings',array(	'sortBy' => 'booking_number',
														'order' => ($sortBy == 'booking_number' && $order == 'desc') ? 'asc' : 'desc',	
														$query_string))}}">Booking Number</a>
													</th>
