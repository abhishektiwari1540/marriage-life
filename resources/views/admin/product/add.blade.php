        ...
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    Add New {{ Config('constants.PRODUCT_TITLE.PRODUCT_TITLE') }} </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        <label for="product_category_id">Select product Category</label><span
                                        ...
                                        <option value="{{ $list->id }}"
                                            {{ old('product_category_id') == $list->id ? 'selected' : '' }}>
                                            {{ $list->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-12 mx-0 px-0">
                                <div class="form-group">
                                    ...
                                    cols="30" rows="5">{{ old('short_description') }}</textarea>
