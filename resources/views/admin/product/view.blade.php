            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">
                        View {{ Config('constants.PRODUCT_TITLE.PRODUCT_TITLE') }}
                    </h5>
                ...
                <div class="card-header card-header-tabs-line">
                    <div class="card-toolbar">
                        ...
                        <li class="nav-item">
                            ...
                            <span class="nav-text">
                                {{ Config('constants.PRODUCT_TITLE.PRODUCT_TITLE') }} Information
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content px-10">
                    <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                        ...
                        <div class="form-group row my-2">
                            ...
                            <div class="col-8">
                                <span
                                class="form-control-plaintext font-weight-bolder">{{ $modelDetails->price ?? '' }}</span>
                            </div>
                        </div>
                        <div class="form-group row my-2">
                            ...
                            <div class="col-8">
                                <span
                                class="form-control-plaintext font-weight-bolder">{{ $modelDetails->stock ?? '' }}</span>
                            </div>
                        </div>
                        <div class="form-group row my-2">
                            ...
                            <div class="col-8">
                                <span
                                class="form-control-plaintext font-weight-bolder">{!! $modelDetails->short_description ?? '' !!}</span>
                            </div>
                        </div>
                        <div class="form-group row my-2">
                        ...
                        <!--<div class="form-group row my-2">
                            <label class="col-4 col-form-label">Multiple Image :</label>
                            <div class="col-8 d-flex">
                                @if ($modelDetails->product_images)
                                    @foreach ($modelDetails->product_images as $k => $val)
                                        <span class="form-control-plaintext font-weight-bolder">
                                            @if (!empty($val->image))
                                                <a class="fancybox-buttons" data-fancybox-group="button"
                                                    href="{{ $val->image ?? '' }}">
                            ...
                            <div class="tab-pane" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                                <div class="dataTables_wrapper ">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @if ($modelDetails->product_specifications)
                                            @foreach ($modelDetails->product_specifications as $k => $val)
                                            <tr>
                                                <td>
